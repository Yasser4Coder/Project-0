    ...
    <form onSubmit={handleSubmit} className="w-full">
      <div className="felx felx-col w-full gap-[30px]">
        ...
        <div className="mb-[5px]">
          <h1 className="text-inherit text-[3.9rem] tracking-[0.1em] font-normal font-inherit text-transparent !bg-clip-text [background:linear-gradient(83.88deg,_#7d26cd,_#e2e2e2)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] inline-block shrink-0 max-w-full mq450:text-26xl mq750:text-41xl">
            LoGin
          </h1>
        </div>
