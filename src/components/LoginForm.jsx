const LoginForm = () => {
  // bg-gradient-to-r from-[#7D26CD]  to-[#E2E2E2] px-[5px] py-[5px] rounded-6xl
  return (
    <form className="w-[1120px] rounded-9xl box-border overflow-hidden shrink-0 flex flex-col items-center justify-start px-5 gap-[67px] max-w-full z-[1] text-center text-56xl text-gainsboro-200 bg-gradient-to-r from-[#7D26CD]  to-[#E2E2E2] px-[5px] py-[5px] rounded-6xl mq450:gap-[17px_67px] mq750:gap-[33px_67px] mq750:box-border">
      <div className="rounded-9xl bg-gray-100 w-full h-full box-border overflow-hidden shrink-0 flex flex-col items-center justify-start pt-16 px-5 pb-[111px] gap-[67px] max-w-full z-[1] text-center text-56xl text-gainsboro-200 font-bord-demo mq450:gap-[17px_67px] mq750:gap-[33px_67px] mq750:pt-[42px] mq750:pb-[72px] mq750:box-border">
