...
const MissionExplanationTech = () => {
  return (
    <div className="conatiner relative z-[9] w-[1350px] m-auto flex flex-col items-center text-center ">
      <div className="titel bg-red-600 text-[38px] lg:text-[28px] mq975:text-[24px] Bord m-0 Bord text-inherit tracking-[0.12em] font-inherit text-transparent !bg-clip-text [background:linear-gradient(83.88deg,_#7d26cd,_#e2e2e2)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]">
        <h1>Intro To The mISSIon</h1>
      </div>
