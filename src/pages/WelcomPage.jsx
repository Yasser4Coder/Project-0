  ...
  return (
    <>
      ...
      <div
        ...
        className="w-full bg-no-repeat bg-cover h-full min-h-[90.4vh] relative bg-gray-100 flex object-cover flex-col items-start justify-start pt-0 px-0 box-border tracking-[normal] mq450:gap-[28px_112px] px-[20px] mq975:gap-[56px_112px]"
      >
