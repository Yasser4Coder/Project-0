    ...
    >
      ...
      <div className="bg-gradient-to-r from-[#7D26CD] to-[#E2E2E2] px-[5px] py-[5px] rounded-6xl self-stretch flex flex-row items-start justify-center py-0 px-10 box-border w-[1200px] lg:w-[990px] mq1025:w-[750px] mx-auto max-w-full">
        <section className="w-full flex flex-col items-end justify-start gap-[30px] max-w-full text-center text-[48px] text-white font-bord-demo">
          <div className="self-stretch rounded-9xl bg-gray-100 box-border overflow-hidden flex flex-col items-center justify-start pt-4 px-5 pb-[61.5px] gap-[89.5px] max-w-full z-[1]  mq700:gap-[22px_89.5px] mq700:pt-5 mq700:pb-10 mq700:box-border mq975:gap-[45px_89.5px]">
