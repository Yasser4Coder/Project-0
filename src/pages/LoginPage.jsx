...
const LoginPage = () => {
  ...
  return (
    <div className="w-full h-[100vh] relative bg-gray-100 overflow-hidden flex flex-col items-start justify-start pt-0 px-0 pb-28 box-border gap-[70px] tracking-[normal] mq450:gap-[28px_112px] mq750:gap-[56px_112px]">
      <img
