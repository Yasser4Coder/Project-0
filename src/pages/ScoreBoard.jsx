    ...
    <div>
      <div className="w-full relative bg-gray-100 overflow-hidden flex flex-col items-start justify-start pt-0 px-0 pb-[173px] box-border gap-[64px] tracking-[normal] mq450:gap-[16px_64px] mq750:gap-[32px_64px]">
        ...
        <main className="self-stretch flex flex-row items-start justify-center py-0 px-5 box-border max-w-full">
          <section className="w-[1120px] rounded-9xl bg-gray-100 box-border overflow-auto shrink-0 flex flex-col items-center justify-start pt-14 pb-[70px] pr-9 pl-9 pl-[21px] gap-[57px] max-w-full z-[1] text-center text-45xl text-blueviolet-200 font-bord-demo border-[3px] border-solid border-blueviolet-200 lg:pt-9 lg:pb-28 lg:box-border mq750:gap-[28px_57px] mq750:pt-[23px] mq750:pb-[73px] mq750:box-border">
