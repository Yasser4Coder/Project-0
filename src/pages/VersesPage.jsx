  ...
  return (
    <div>
      <div
        ...
        className="w-full bg-no-repeat bg-cover  h-full min-h-[100vh] relative bg-gray-100 flex flex-col items-start justify-start pt-0 px-0 pb-[110px] box-border gap-[50px] tracking-[normal] mq450:gap-[20px_79px] mq750:gap-[39px_79px]"
      >
