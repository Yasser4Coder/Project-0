...
const VersesPage = () => {
  ...
  return (
    <div>
      <div className="w-full relative bg-gray-100 overflow-hidden flex flex-col items-start justify-start pt-0 px-0 pb-[202px] box-border gap-[50px] tracking-[normal] mq450:gap-[20px_79px] mq750:gap-[39px_79px]">
        <img
