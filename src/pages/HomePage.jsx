          ...
          <section className="w-[1120px] rounded-9xl bg-gray-100 box-border overflow-hidden shrink-0 flex flex-col items-center justify-start pt-14 px-5 pb-[81px] gap-[70px] max-w-full z-[1] text-center text-45xl text-white font-bord-demo border-[3px] border-solid border-blueviolet-200 lg:pt-9 lg:pb-[53px] lg:box-border">
            <div className="w-[930px] flex flex-col items-start justify-start gap-[24px] max-w-full">
              ...
              <h1 className="m-0 Segoe self-stretch h-full text-17xl  tracking-[0.13em] inline-block shrink-0 mb-[30px] mq450:text-3xl mq1050:text-10xl">
                Vegapunk attempted to discover the world's secret by building a
                time machine, but his experiment went awry, leading in the
                creation of a space-time machine that united four universes: One
                Piece, Sherlock Holmes, Watch Dogs, and Doctor Strange. This
                incident created a concern because the four universes clashed,
                resulting in their demise. Feeling responsible, Vegapunk
                attempted to lock the gates but realized he couldn't do so alone
                in his own universe. He went out to anybody in the impacted
                universes, but only Doctor Strange received the message.
                However, as the hero he is, Doctor Strange transmitted the
                message to Sherlock, Aiden Pearce, and Vegapunk, imploring them
